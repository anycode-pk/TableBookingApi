...
ALTER TABLE "Restaurants"
    RENAME COLUMN "SecondaryImageURL" TO "SecondaryImageUrl";

ALTER TABLE "Restaurants"
    RENAME COLUMN "PrimaryImageURL" TO "PrimaryImageUrl";

ALTER TABLE "Users"
    ALTER COLUMN "RefreshToken" TYPE character varying(512);

ALTER TABLE "Restaurants"
    ALTER COLUMN "Type" TYPE character varying(100);

ALTER TABLE "Restaurants"
    ALTER COLUMN "SecondaryImageUrl" TYPE character varying(1000);

ALTER TABLE "Restaurants"
    ALTER COLUMN "PrimaryImageUrl" TYPE character varying(1000);
...
ALTER TABLE "Restaurants"
    ALTER COLUMN "Description" TYPE character varying(100);
UPDATE "Restaurants"
SET "Description" = ''
...
ALTER TABLE "Ratings"
    ALTER COLUMN "Comment" TYPE character varying(500);
...
ALTER TABLE "Bookings"
    ADD "RestaurantId" uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
